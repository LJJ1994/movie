  ...
  <section id='hot'>
    <ul>
      <li :class="{'border-bottom': hotLists[hotLists.length-1] != item}" v-for="item in hotLists">
        <figure class="m-img ml fl pr" @click="playMovieVideo(item.preview[0].iphoneUrl, `https://gw.alicdn.com/${item.poster}`)">
...
.full-star {
  ...
  /*background-image里的url图片引用使用url('~@/assets/images/')格式*/
